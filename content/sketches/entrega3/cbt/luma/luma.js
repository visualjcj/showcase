...
function preload() {
  lumaShader = readShader('/showcase/sketches/entrega3/cbt/luma/luma.frag', { varyings: Tree.texcoords2 });
  // image source: https://en.wikipedia.org/wiki/HSL_and_HSV#/media/File:Fire_breathing_2_Luc_Viatour.jpg
  img = loadImage('/showcase/sketches/entrega3/cbt/luma/fire_breathing.png');
}
